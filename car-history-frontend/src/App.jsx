...
class App extends Component {
  ...
  deployExampleContract() {
    ...
    const contract = new this.web3.eth.Contract(exampleContractABIInterface, null, {
      gas: '4700000',
